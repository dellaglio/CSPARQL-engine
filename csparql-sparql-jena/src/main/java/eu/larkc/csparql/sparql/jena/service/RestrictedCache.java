...
import eu.larkc.csparql.sparql.jena.service.CacheAcqua.EntrySet;

public class RestrictedCache extends CacheLRU<Binding,Set<Binding>> {
//	private int cacheSize=50;
	...
	public RestrictedCache(float loadFactor, int maxSize, Set<Var> keys, Set<Var> values){
	...
	public RestrictedCache(int cacheSize, Set<Var> keys, Set<Var> values){
